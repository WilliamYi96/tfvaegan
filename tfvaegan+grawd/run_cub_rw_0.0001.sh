...
--feed_lr 0.0001 --dec_lr 0.0001 --feedback_loop 2 --a1 0.01 --a2 0.01 --rw_weight 1 --creative_weight 0.0001 \
...
--recons_weight 0.01 --a1 1 --a2 1 --feed_lr 0.00001 --dec_lr 0.0001 --feedback_loop 2 --rw_weight 1 --creative_weight 0.0001 \
--n_examples_per_proto 10
...
--recons_weight 0.01 --feedback_loop 2 --feed_lr 0.00001 --a1 0.5 --a2 0.5 --dec_lr 0.0001 --rw_weight 1 --creative_weight 0.0001 \
--n_examples_per_proto 10
...
--recons_weight 0.01 --a1 0.1 --a2 0.01 --feedback_loop 2 --feed_lr 0.0001 --rw_weight 1 --creative_weight 0.0001 \
--n_examples_per_proto 10
