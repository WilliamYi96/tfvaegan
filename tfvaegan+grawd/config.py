...
parser.add_argument('--rw_weight', type=float, default=1.0, help='visit weight.')
parser.add_argument('--creative_weight', type=float, default=1.0, help='creative_loss_weight.')
parser.add_argument('--n_examples_per_proto', type=int, default=10, help='examples per prototype.')
parser.add_argument('--space', type=str, default='feature', help='prototype space.')
parser.add_argument('--similarity_measure', type=str, default='l2_distance', help='.')
parser.add_argument('--dot_product_scale', type=int, default=3, help='.')
parser.add_argument('--class_visit_loss_coef', type=float, default=0.1, help='.')
parser.add_argument('--num_steps', type=int, default=3, help='.')
